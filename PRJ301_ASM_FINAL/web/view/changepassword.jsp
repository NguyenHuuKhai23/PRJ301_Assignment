                ...
                <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
                    <form action="changepassword" method="post">
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <% } else { %>
                                <div class="form-floating mb-2">
                                <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="pass1" value="${requestScope.pass1_sv}">
                                <label for="floatingPassword">New Password</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="pass2" value="${requestScope.pass2_sv}">
                            ...
                            <input type="submit" value="Change" class="btn btn-primary py-3 w-100 mb-4">
                            </form>
